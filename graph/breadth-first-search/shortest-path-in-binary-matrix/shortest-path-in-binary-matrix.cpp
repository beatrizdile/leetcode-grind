        ...
        int bfs(vector<vector<int>>& grid, pair<int, int> coord) {
            ...
            while (!q.empty()) {
                ...
                for (int num = 0; num < size; num++) {
                    ...
                    if (!(pos.first + 1 < 0 || pos.first + 1 >= grid.size() || pos.second + 1 < 0 || pos.second + 1 >= grid[pos.first + 1].size() || grid[pos.first + 1][pos.second + 1] == 1 || visited[pos.first + 1][pos.second + 1] == 1)) {
